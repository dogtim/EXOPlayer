...
public class DoublePlayerActivity extends AppCompatActivity
  ...
  protected StyledPlayerView playerView2;
  protected LinearLayout debugRootView;
  protected TextView debugTextView;
  protected TextView debugTextView2;
  protected @Nullable SimpleExoPlayer player;
  protected @Nullable SimpleExoPlayer player2;
  ...
  private DebugTextViewHelper debugViewHelper2;
  ...
  public void onCreate(Bundle savedInstanceState) {
    ...
    debugTextView2 = findViewById(R.id.debug_text_view_2);
  ...
  protected void setContentView() {
    setContentView(R.layout.double_player_activity);
  }
  ...
  protected boolean initializePlayer() {
    ...
    if (player2 == null) {
      ...
      player2.addAnalyticsListener(new EventLogger(trackSelector));
      player2.setAudioAttributes(AudioAttributes.DEFAULT, /* handleAudioFocus= */ true);
      player2.setPlayWhenReady(startAutoPlay);
      playerView2.setPlayer(player2);
      debugViewHelper2 = new DebugTextViewHelper(player2, debugTextView2);
    ...
    if (haveStartPosition) {
      player2.seekTo(startWindow, startPosition);
    }
    player2.setMediaItems(mediaItems, /* resetPosition= */ !haveStartPosition);
    player2.prepare();
